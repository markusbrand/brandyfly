...
The application SHALL render OpenStreetMap and OpenTopoMap raster tiles in `MapWidget` and cache downloaded tiles locally to enable seamless offline operation.
