...
void main() {
  group('FlightReplayService Tests', () {
    ...
    test('Speed multiplier cycles 1x -> 2x -> 5x -> 10x -> 1x', () {
      expect(replay.speedMultiplier, 1);
      replay.cycleSpeedMultiplier();
      expect(replay.speedMultiplier, 2);
      replay.cycleSpeedMultiplier();
      expect(replay.speedMultiplier, 5);
      replay.cycleSpeedMultiplier();
      expect(replay.speedMultiplier, 10);
      // Tap at 10x cycles back to 1x
      replay.cycleSpeedMultiplier();
      expect(replay.speedMultiplier, 1);
    });
